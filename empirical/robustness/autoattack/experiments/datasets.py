...
class Flowers(DataSet):
    def __init__(self, data_path, **kwargs):
        ...
        ds_kwargs = self.override_args(ds_kwargs, kwargs)
        super(Flowers, self).__init__('flowers', data_path, **ds_kwargs)
...
#        ds_kwargs = self.override_args(ds_kwargs, kwargs)
#        super(Caltech101, self).__init__('caltech101', data_path, **ds_kwargs)
...
class Pets(DataSet):
    def __init__(self, data_path, **kwargs):
        ...
        ds_kwargs = self.override_args(ds_kwargs, kwargs)
        super(Pets, self).__init__('pets', data_path, **ds_kwargs)
...
class DTD(DataSet):
    def __init__(self, data_path='/tmp/', **kwargs):
        ds_kwargs = {
            ...
            'mean': ch.tensor([0., 0., 0.]),
            'std': ch.tensor([1., 1., 1.]),
            'custom_class': dtd.DTD,
            'label_mapping': None,
            'transform_train': da.TRAIN_TRANSFORMS_IMAGENET,
            'transform_test': da.TEST_TRANSFORMS_IMAGENET
        }
        ds_kwargs = self.override_args(ds_kwargs, kwargs)
        super(DTD, self).__init__('dtd', data_path, **ds_kwargs)

    def get_model(self, arch, pretrained):
        return imagenet_models.__dict__[arch](pretrained=pretrained, num_classes=self.num_classes)
...
class Aircraft(DataSet):
    def __init__(self, data_path='/tmp/', **kwargs):
        ds_kwargs = {
            ...
            'mean': ch.tensor([0., 0., 0.]),
            'std': ch.tensor([1., 1., 1.]),
            'custom_class': aircraft.FGVCAircraft,
            'label_mapping': None,
            'transform_train': da.TRAIN_TRANSFORMS_IMAGENET,
            'transform_test': da.TEST_TRANSFORMS_IMAGENET
        }
        ds_kwargs = self.override_args(ds_kwargs, kwargs)
        super(Aircraft, self).__init__('aircraft', data_path, **ds_kwargs)
...
class Cars(DataSet):
    def __init__(self, data_path, **kwargs):
        ...
        ds_kwargs = self.override_args(ds_kwargs, kwargs)
        super(Cars, self).__init__('cars', data_path, **ds_kwargs)
...
#        Modify 2 lines below
#        ds_kwargs = self.override_args(ds_kwargs, kwargs)
#        super(Caltech256, self).__init__('caltech256', data_path, **ds_kwargs)
...
class SUN397(DataSet):
    def __init__(self, data_path, **kwargs):
        ...
        ds_kwargs = self.override_args(ds_kwargs, kwargs)
        super(SUN397, self).__init__('sun397', data_path, **ds_kwargs)
...
class Birds(DataSet):
    def __init__(self, data_path, **kwargs):
        ...
        ds_kwargs = self.override_args(ds_kwargs, kwargs)
        super(Birds, self).__init__('birds', data_path, **ds_kwargs)
...
class CIFAR10_224(DataSet):
    def __init__(self, data_path='/tmp/', **kwargs):
        ...
        ds_kwargs = self.override_args(ds_kwargs, kwargs)
        super(CIFAR10_224, self).__init__('cifar10_224', data_path, **ds_kwargs)

    def get_model(self, arch, pretrained):
        return imagenet_models.__dict__[arch](pretrained=pretrained, num_classes=self.num_classes)


class CIFAR100_224(DataSet):
    def __init__(self, data_path='/tmp/', **kwargs):
        ds_kwargs = {
            'num_classes': 100,
        ...
        ds_kwargs = self.override_args(ds_kwargs, kwargs)
        super(CIFAR100_224, self).__init__('cifar100_224', data_path, **ds_kwargs)
